            ...
            <div className="row">
              ...
              <div className="col-6">
                ...
                <div className="table-responsive">
                  ...
                  <button className="btn btn-dark" style={{width: "100%"}}  onClick={()=>handlefinish()}>Finish Order</button>
                </div>
              </div>
